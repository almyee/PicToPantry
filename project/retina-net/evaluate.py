# python3 evaluate_retinanet.py  # Outputs mAP@0.5, mAP@0.75, mAP@[.5:.95], etc.
...
model_path = "retinanet_finetuned.pth"
...
in_features = model.head.cls_logits.in_features
...
# Save results
res_file = "retinanet_results.json"
